...
public class OrdemServico implements Serializable {
	...
	public OrdemServico(Long id, Cliente cliente, String descricao, BigDecimal preco, StatusOrderService status,
	...
	public void finalizar() {
		if(!StatusOrderService.ABERTA.equals(getStatus())) {
			throw new DBException("Ordem de serviço não pode ser finalizada!");
		}
